...
namespace SkillChat.Server.Hubs
{
	public class ChatHub : Hub, IChatHub
	{
		...
		public async Task UpdateUserDisplayName(string userDispalyName, string userId)
		{
			...
			Log.Information($"User Id:{userId} change display user name to {userDispalyName}");
		}
